...
class MoE(nn.Module):
    def __init__(self, input_size, output_size, num_experts, device, num_nodes=1, d_model=32, d_ff=64, dynamic=False,
        ...
        self.seasonality_and_trend_outputs = None
        self.gates = None
    ...
    def seasonality_and_trend_decompose(self, x):
        ...
        # 保存分解的输出  
        self.seasonality_and_trend_outputs = x + seasonality + trend
        self.seasonality_and_trend_outputs.detach().cpu().numpy()
    ...
    def noisy_top_k_gating(self, x, train, noise_epsilon=1e-2):
        ...
        self.gates = top_k_gates
        self.gates.detach().cpu().numpy()  
