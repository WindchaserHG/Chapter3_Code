...
# 遍历不同的异常比率和序列长度
for residual_connection in 0 1; do
    for batch_norm in 0 1; do
        # 构建日志文件路径
        log_file="logs_exp/Exp3/${model_id_name}_batch_norm${batch_norm}_residual_connection${residual_connection}.log"
