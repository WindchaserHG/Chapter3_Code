...
# 遍历不同的异常比率和序列长度
for anomaly_ratio in 2 3 5 10; do
    for seq_len in 96; do
        # 构建日志文件路径
        log_file="logs_exp/Exp7/${model_id_name}_ad${anomaly_ratio}_seq_len${seq_len}.log"
